...
async function getLayoutData() {
    try {
        ...
        const [navLinks, teacherNavLinks, footerContent] = await Promise.all([
            ...
            db.collection('navlinks').find({}).sort({
                order: 1
            }).toArray(),
            ...
            db.collection('teachernavlinks').find({}).sort({
                order: 1
            }).toArray(),
        ...
        return {
            ...
            teacherNavLinks: JSON.parse(JSON.stringify(teacherNavLinks)),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3e3ee55e._.js.map