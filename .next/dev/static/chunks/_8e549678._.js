...
;
;
// --- GIẢI THÍCH REFACTOR LẦN 2 ---
//
// Lần refactor này tập trung vào việc tích hợp Sidebar và thay đổi cơ chế gọi AI.
//
// 1. **TÁCH SIDEBAR THÀNH COMPONENT RIÊNG:**
//    - Toàn bộ cột bên phải (Phân loại & Hành động) đã được đưa vào component `CreateQuestionSidebar.tsx`.
//    - Component này nhận state và các hàm xử lý từ trang chính, giúp trang chính (`page.tsx`) chỉ tập trung vào việc quản lý dữ liệu tổng thể.
//
// 2. **THAY ĐỔI CƠ CHẾ GỌI AI:**
//    - Đã loại bỏ thẻ `<form>` và `Server Action`.
//    - Nút "Trích xuất với AI" giờ đây sẽ gọi hàm `handleExtractWithAI`.
//    - Hàm này sử dụng `fetch` để gửi yêu cầu đến một API endpoint giả định là `/api/ai/extract-question`.
//    - Luồng dữ liệu mới: Client -> API Route -> AI Service -> Client. Điều này phù hợp với mô hình của bạn đã mô tả.
//
// 3. **CẢI TIẾN TRẢI NGHIỆM NGƯỜI DÙNG (UX):**
//    - Các nút trong sidebar ("Lưu", "Hủy"...) giờ đã có hành động cụ thể.
//    - Thêm `useRouter` để điều hướng sau khi thực hiện hành động.
//
// ==> KẾT QUẢ: Cấu trúc trang rõ ràng hơn, với sự phân chia trách nhiệm rành mạch:
//    - `page.tsx`: Quản lý state tổng, bố cục chính.
//    - `CreateQuestionSidebar.tsx`: Quản lý UI và tương tác của cột sidebar.
//    - Các component trong `components/ui`: Các "viên gạch" UI cơ bản, có thể tái sử dụng ở mọi nơi.
const CreateQuestionWithAIPage = ()=>{
    ...
    const handleExtractWithAI = async ()=>{
        if (!rawInput.trim()) {
            setError("Vui lòng nhập nội dung câu hỏi thô.");
            return;
        }
        setError(null);
        startTransition(async ()=>{
            try {
                ...
                setCorrectIndex(result.data?.correctOptionIndex ?? null);
                setExplanation(result.data?.explanation || '');
                setDifficulty(result.data?.difficulty || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$definitions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Difficulty"].EASY);
                setTopic(result.data?.topic || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$definitions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Topic"].GRAMMAR);
    ...
    const handleSave = ()=>{
        ...
        alert("Câu hỏi đã được lưu thành công! (giả lập)");
        router.push('/dashboard/teacher/questions');
    };
    const handleSaveAndContinue = ()=>{
        console.log("Đã nhấn Lưu & Tiếp tục:", {
            questionText,
            options,
            correctIndex,
            explanation,
        ...
        alert("Câu hỏi đã được lưu, làm mới trang để tạo câu hỏi tiếp theo! (giả lập)");
        // Reset state để tạo câu hỏi mới
        setRawInput('');
        setQuestionText('');
        setOptions([
            '',
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Cung cấp dữ liệu và để AI tự động phân tích và tạo câu hỏi."
                                }, void 0, false, {
                                    fileName: "[project]/src/app/dashboard/teacher/questions/create/page.tsx",
                                    lineNumber: 168,
                                    columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Textarea$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                ...
                                                placeholder: "Ví dụ: Question: What is the capital of France? A. London B. Paris..."
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/teacher/questions/create/page.tsx",
                                                lineNumber: 191,
                                                columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Label$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        ...
                                        children: "Các phương án trả lời"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/dashboard/teacher/questions/create/page.tsx",
                                        lineNumber: 234,
                                        columnNumber: 13
...
_s(CreateQuestionWithAIPage, "UPEmWp6T5C5wnZOsVAm/V65Uwso=", false, function() {
    return [
...
//# sourceMappingURL=_8e549678._.js.map